...
class View():
    ...
    def load_interface(self):
        ...
        # text field for anno, brand e retailer
        self.anno = ft.Dropdown(
            label="anno",
            width=200,
        )
        ...
        self.retailer = ft.Dropdown(
            label="retailer",
            width=200,
        )
        self._controller.fillddRetailer()
        row1 = ft.Row(controls=[self.anno, self.brand, self.retailer], alignment=ft.MainAxisAlignment.CENTER)
